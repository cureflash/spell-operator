(() => {
  ...
  function openPluginComputer(){if(!fieldScreenActive()||dialogIsOpen()||storyOverlayIsOpen())return;G.openComputer?.();const kicker=G.screens.hub?.querySelector(".screen-heading .kicker");if(kicker)kicker.textContent='ソフィー「プラグイン！ルミエル.EXE トランスミッション！」'}
